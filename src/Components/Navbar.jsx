...
export function Navbar() {
    return (
        <nav className="bg-white-400 px-16 py-5 flex justify-between items-center w-full">
            ...
            <div className="font-normal text-lg " >
                ...
                <Link className="text-black mx-7">Más populares</Link>
                <Link className="text-black mx-7" to='/'>Nosotros</Link>
                          
                <Link className="bg-blue-600 text-white w-auto px-5 py-1 rounded-3xl" to='/login'>
                    Entrar
                </Link>
            </div>
        </nav>
